...
```{r}
favstats(~Reinforced.MASTER$`Attention Control` | Reinforced.MASTER$`Session #`)
favstats(~Reinforced.MASTER$`Attention Test` | Reinforced.MASTER$`Session #`)
favstats(~Reinforced.MASTER$Alone | Reinforced.MASTER$`Session #`)
```
